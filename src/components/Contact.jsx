...
const Field = ({ id, label, type = "text", register, error, rows, required, maxLength, watch }) => {
    ...
    const base = `peer w-full px-4 rounded-xl text-sm font-medium outline-none transition-all duration-300
        ...
        border ${error
            ...
            : "border-slate-200/80 dark:border-white/[0.08] hover:border-indigo-300/50 focus:border-indigo-400/60 focus:ring-4 focus:ring-indigo-500/10 dark:focus:ring-indigo-400/10"
        }
            ...
            <div className="container relative z-10">
                ...
                <div className="grid lg:grid-cols-5 gap-10 lg:gap-14 items-start">
                    ...
                    >
                        ...
                        {/* Card */}
                        <div className="relative bg-white/78 dark:bg-white/[0.025] backdrop-blur-2xl rounded-3xl
                            border border-white/80 dark:border-white/[0.07]
                            shadow-[0_8px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_8px_60px_rgba(0,0,0,0.3)]
                            overflow-hidden">
                            ...
                            <div className="p-8 md:p-10">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <Field id="phone" label="Phone Number" register={register("phone")} error={errors.phone} />
                                    </div>
